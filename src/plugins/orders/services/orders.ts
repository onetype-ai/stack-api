...
export class OrdersService
{
    ...
    async reserve(productId: string): Promise<Order>
    {
        ...
        return this.#ctx.tx(async (inside) =>
        {
            ...
            /* OrderContext, so a rolled-back reservation schedules no release. */
